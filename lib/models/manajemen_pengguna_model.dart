...
ManajemenPenggunaModel manajemenPenggunaModelFromJson(String str) => ManajemenPenggunaModel.fromJson(json.decode(str));

String manajemenPenggunaModelToJson(ManajemenPenggunaModel data) => json.encode(data.toJson());
...
class ManajemenPenggunaModel {
    ...
    factory ManajemenPenggunaModel.fromJson(Map<String, dynamic> json) => ManajemenPenggunaModel(
        status: json["status"] == null ? null : json["status"],
        statusCode: json["status_code"] == null ? null : json["status_code"],
        message: json["message"] == null ? null : json["message"],
        users: json["users"] == null ? null : List<Pengguna>.from(json["users"].map((x) => Pengguna.fromJson(x))),
    );
